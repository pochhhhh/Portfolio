...
<div id="project-a" class="box">
    ...
    <div id="simon-game" class="project-name hidden"><h1>Simon Game</h1><i class="project-github-logo fa fa-github fa-4x"></i></div>
    <div id="simon-game-tech" class="technologies hidden">
<i class="fab fa-js fa-4x"></i>
    ...
    <div class="hover-layer">
  <div class="project-name"><h1>BiggyTravels</h1><i class="project-github-logo fa fa-github fa-4x"></i></div>
...
<div class="hover-layer">
<div class="project-name"><h1>Portfolio Site</h1><i class="project-github-logo fa fa-github fa-4x"></i></div>
